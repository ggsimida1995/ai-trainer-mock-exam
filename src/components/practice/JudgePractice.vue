...
const judgeQuestions = computed(() => questionBank.value.judgeQuestions)
const currentQuestion = computed(() => judgeQuestions.value[currentIndex.value])
const totalQuestions = computed(() => judgeQuestions.value.length)
const completedCount = computed(() => currentIndex.value)

const score = computed(() => {
  return judgeQuestions.value.reduce((acc: number, question: Question) => {
...
const restartPractice = () => {
  judgeQuestions.value.forEach((question: Question) => {
    question.userAnswer = ''
  })
