    ...
    <div class="content-wrapper">
      <div v-if="!isFinished" class="question-container">
        <QuestionCard
          ...
          @answer="handleAnswer"
          @next="nextQuestion"
          @show-result="(show) => showResult = show"
        />
      </div>
...
const singleQuestions = computed(() => questionBank.value.singleQuestions)
const currentQuestion = computed(() => singleQuestions.value[currentIndex.value])
const totalQuestions = computed(() => singleQuestions.value.length)
const completedCount = computed(() => currentIndex.value)

const score = computed(() => {
  return singleQuestions.value.reduce((acc: number, question: Question) => {
...
const handleAnswer = (answer: string | string[]) => {
  if (currentQuestion.value) {
    currentQuestion.value.userAnswer = typeof answer === 'string' ? answer : answer[0]
...
const restartPractice = () => {
  ...
  showResult.value = false
  singleQuestions.value.forEach((question: Question) => {
    question.userAnswer = ''
  })
}
